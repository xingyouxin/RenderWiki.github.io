...
<div align=center>![figure-1](https://user-images.githubusercontent.com/73336853/153031807-59afe922-6077-4b84-b36b-3c029636f974.png)</div>
<center>图1 包围体基本种类及比较</center>  

&emsp;&emsp;如图1，常见的包围体类型有球体，AABB（axis-aligned bounding box轴对齐包围盒），OBB（oriented bounding box方向包围盒），8-DOP，凸壳。其中简单性由大到小，紧密性由小至大。  

## 测试

xxxxxx aaaa bbbb dddd
...
<div align=center>![figure-2](https://user-images.githubusercontent.com/73336853/153032059-f7a933e3-b366-487b-a341-6f2c1c3e3d54.png)</div>
<center>图2 球和OBB的相交测试</center>
&emsp;&emsp;如图2，两对称物体的中心距离投影d小于各自投影半径之和`rA+rB`，投影区间分离，两物体分离。  
...
&emsp;&emsp;以AABB和AABB相交测试为例，只需要考虑面-面测试，因此只需要考虑3个分离轴（x-，y-，z-轴）。以OBB和OBB的相交测试为例，面-面（面-边）测试需要考虑`3+3=6`个分离轴，边-边测试需要考虑`3*3=9`条分离轴，共需测试15条分离轴。  
