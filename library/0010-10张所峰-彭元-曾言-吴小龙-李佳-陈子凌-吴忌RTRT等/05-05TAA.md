...
$$
\varepsilon_n(p)=B_3\ast(f_{n-1}-s_n)(p)\\
...
[18] NETZEL R., AMENT M., BURCH M., WEISKOPF D.: Spectral Analysis of Higher-Order and BFECC Texture Advection. In International Symposium on Vision, Modeling and Visualization (VMV) (2012).
